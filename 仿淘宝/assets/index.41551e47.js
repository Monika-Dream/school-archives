...
(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, global2.Swiper = factory());
})(globalThis, function() {
  function isObject$12(obj) {
    return obj !== null && typeof obj === "object" && "constructor" in obj && obj.constructor === Object;
  }
  function extend$12(target, src) {
    if (target === void 0) {
      target = {};
    }
    if (src === void 0) {
    ...
    Object.keys(src).forEach((key) => {
      if (typeof target[key] === "undefined")
        target[key] = src[key];
      else if (isObject$12(src[key]) && isObject$12(target[key]) && Object.keys(src[key]).length > 0) {
        extend$12(target[key], src[key]);
      }
    });
  }
  const ssrDocument = {
  ...
  function Pagination(_ref) {
    ...
    function render() {
      ...
      if (params.type !== "custom") {
        emit2("paginationRender", swiper.pagination.$el[0]);
      }
    }
    function init() {
  ...
  function Parallax(_ref) {
    ...
    const setTransform = (el, progress) => {
      ...
      const p2 = $el.attr("data-swiper-parallax") || "0";
    ...
    function loadInSlide(index2, loadInDuplicate) {
      ...
      $images.each((imageEl) => {
        ...
        swiper.loadImage($imageEl[0], src || background, srcset, sizes, false, () => {
          ...
          emit2("lazyImageReady", $slideEl[0], $imageEl[0]);
          if (swiper.params.autoHeight) {
            swiper.updateAutoHeight();
          }
        });
        emit2("lazyImageLoad", $slideEl[0], $imageEl[0]);
      });
    }
    function load() {
      const {
...
const _hoisted_2$1 = { class: "supermarket_container" };
const _hoisted_3$1 = { class: "supermarket" };
const _hoisted_4$1 = { class: "header" };
const _hoisted_5$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("li", null, null, -1));
const _hoisted_6$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("input", { type: "text" }, null, -1));
const _hoisted_7$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("li", null, null, -1));
const _hoisted_8$1 = {
  class: "Classify",
  style: { "grid-area": "Classify" }
};
...
const _hoisted_15 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", { class: "swiper-button-next" }, null, -1));
const _hoisted_16 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", { class: "swiper-button-prev" }, null, -1));
const _hoisted_17 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("div", { class: "swiper-pagination" }, null, -1));
...
const _sfc_main$1 = {
  __name: "index",
  setup(__props) {
    const Like = defineAsyncComponent(() => __vitePreload(() => import("./like.e6978e40.js"), true ? ["./like.e6978e40.js","./like.38e6f2df.css"] : void 0, import.meta.url));
    let iskeep = ref(true);
    onActivated(() => {
      iskeep.value = true;
      nextTick(() => {
    ...
    let Image_data = [
      "https://pic2.zhimg.com/v2-c7f0f185e5f702d993d6ec23c34ed059_r.jpg",
      "https://tse2-mm.cn.bing.net/th/id/OIP-C.bszCsnAt8O85l6TMRjgixAHaEo?pid=ImgDet&rs=1",
      "https://pica.zhimg.com/v2-d7349a14333c2b7312e83112e29ff4ef_r.jpg",
      "https://img.3dmgame.com/uploads/images/news/20181227/1545898284_509495.jpg",
      "https://img.3dmgame.com/uploads/images/news/20220323/1648017489_319800.png",
      "https://image.api.playstation.com/vulcan/img/rnd/202107/1418/3xIQlFWEBEUNrbSOpbUxu7Pd.png"
    ];
    return (_ctx, _cache) => {
            ...
            createBaseVNode("ul", _hoisted_4$1, [
              ...
              createBaseVNode("li", null, [
                ...
                createBaseVNode("ul", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(Search_data), (i, item) => {
                    return openBlock(), createElementBlock("li", { key: item }, toDisplayString(i), 1);
                  }), 128))
                ])
              ]),
              _hoisted_7$1
            ...
            createBaseVNode("nav", null, [
              createBaseVNode("div", _hoisted_8$1, [
                createBaseVNode("dl", null, [
                  _hoisted_9$1,
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(Classify_data), (i, index) => {
                    return openBlock(), createElementBlock("dd", { key: index }, toDisplayString(i), 1);
                  }), 128))
                ])
              ]),
              createBaseVNode("div", _hoisted_10$1, [
                createBaseVNode("ul", null, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(unref(Grouping_data), (i, index) => {
                    return openBlock(), createElementBlock("li", { key: index }, toDisplayString(i), 1);
                  }), 128))
                ])
              ]),
              createBaseVNode("div", _hoisted_11$1, [
                createBaseVNode("div", null, [
                  unref(iskeep) ? (openBlock(), createElementBlock("div", _hoisted_12, [
                    createBaseVNode("div", _hoisted_13, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(Image_data), (i, index) => {
...
const routes = [
  ...
  },
  {
    path: "/login",
    name: "Login",
    component: () => __vitePreload(() => import("./index.8546e9a9.js"), true ? ["./index.8546e9a9.js","./index.d969b6b9.css"] : void 0, import.meta.url),
    meta: {
      StopShowLogin: true
    }
  },
  {
    path: "/customer",
    name: "Customer",
    component: () => __vitePreload(() => import("./index.25095a87.js"), true ? ["./index.25095a87.js","./index.3deb2dee.css"] : void 0, import.meta.url)
  }
];
...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    !_ctx.$route.meta.StopShowLogin ? (openBlock(), createElementBlock("nav", _hoisted_2, [
      createBaseVNode("ul", null, [
        _hoisted_3,
        createBaseVNode("li", null, [
          createVNode(_component_router_link, { to: { name: "Login" } }, {
            default: withCtx(() => [
              createTextVNode("\u4EB2\uFF0C\u8BF7\u767B\u5F55")
            ]),
            _: 1
          })
        ]),
        ...
        _hoisted_6,
        createBaseVNode("li", null, [
          createTextVNode(" \u6211\u7684\u6DD8\u5B9D "),
          createBaseVNode("div", _hoisted_7, [
            createBaseVNode("span", null, [
              createVNode(_component_router_link, { to: { name: "Login" } }, {
                default: withCtx(() => [
                  createTextVNode("\u5DF2\u4E70\u5230\u7684\u5B9D\u8D1D")
                ]),
                _: 1
              })
            ]),
        ...
        _hoisted_10,
        createBaseVNode("li", null, [
          createVNode(_component_router_link, { to: { name: "Customer" } }, {
            default: withCtx(() => [
              createTextVNode("\u8054\u7CFB\u5BA2\u670D")
            ]),
            _: 1
          })
        ])
    ...
    createVNode(_component_router_view, null, {
      default: withCtx(({ Component }) => [
        (openBlock(), createBlock(KeepAlive, null, [
          _ctx.$route.meta.isKeepAlive ? (openBlock(), createBlock(resolveDynamicComponent(Component), { key: 0 })) : createCommentVNode("", true)
        ], 1024)),
        !_ctx.$route.meta.isKeepAlive ? (openBlock(), createBlock(resolveDynamicComponent(Component), { key: 0 })) : createCommentVNode("", true)
      ]),
      _: 1
